...
declare namespace Rules {
    ...
    export interface Graphql {
         'graphql/capitalized-type-name' : RuleType
         'graphql/named-operations' : RuleType
         'graphql/no-deprecated-fields' : RuleType
         'graphql/required-fields' : RuleType
         'graphql/template-strings' : RuleType
    }
